...
namespace Korot
{
    public partial class frmSettings : Form
    {
        ...
        private void newTSMI_Click(object sender, EventArgs e)
        {
            ...
            HTInputBox input = new HTInputBox("Korot", cefform.anaform.ThemeSaveInfo, new HTDialogBoxContext { OK = true, Cancel = true, }, Path.GetFileNameWithoutExtension(Settings.Theme.ThemeFile)) { Icon = cefform.anaform.Icon, OK = cefform.anaform.OK, Cancel = cefform.anaform.Cancel, SetToDefault = cefform.anaform.SetToDefault, BackgroundColor = Settings.Theme.BackColor };
        ...
        private void ımageFromURLToolStripMenuItem_Click(object sender, EventArgs e)
        {
            HTAlt.WinForms.HTInputBox inputbox = new HTAlt.WinForms.HTInputBox("Korot",
                                                                                            ...
                                                                                            "")
            { Icon = Icon, SetToDefault = cefform.anaform.SetToDefault, StartPosition = FormStartPosition.CenterParent, OK = cefform.anaform.OK, Cancel = cefform.anaform.Cancel, BackgroundColor = Settings.Theme.BackColor };
        ...
        {
            HTAlt.WinForms.HTInputBox inputb = new HTAlt.WinForms.HTInputBox("Korot", cefform.anaform.enterAValidUrl, Settings.SearchEngine) { Icon = Icon, SetToDefault = cefform.anaform.SetToDefault, StartPosition = FormStartPosition.CenterParent, OK = cefform.anaform.OK, Cancel = cefform.anaform.Cancel, BackgroundColor = Settings.Theme.BackColor };
        ...
        {
            HTAlt.WinForms.HTInputBox inputb = new HTAlt.WinForms.HTInputBox(cefform.anaform.customSearchNote, cefform.anaform.customSearchMessage, Settings.SearchEngine) { Icon = Icon, SetToDefault = cefform.anaform.SetToDefault, StartPosition = FormStartPosition.CenterParent, OK = cefform.anaform.OK, Cancel = cefform.anaform.Cancel, BackgroundColor = Settings.Theme.BackColor };
            DialogResult diagres = inputb.ShowDialog();
            if (diagres == DialogResult.OK)
            {
